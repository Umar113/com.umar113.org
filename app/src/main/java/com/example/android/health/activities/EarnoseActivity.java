 ...
 */
public class EarnoseActivity extends AppCompatActivity {
    private ProgressDialog pDialog1;
    private static final String TAG_SUCCESS = "status";
    private static final String TAG_USERS = "earnosespecialist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/earnosespecialist.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(EarnoseActivity.this);
...
//                        String faddress=c.getString("faddress");
                        myorderArray.add(new MyorderData(name,hospital,address,exp,"",""));
                    }
                } else {
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(EarnoseActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
