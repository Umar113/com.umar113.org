...
private static final String TAG_USERS = "dermatologist";
...
public static final String LOGIN_URL = "http://ssinfotech.org/health/dermatologist.php";
        JSONObject json_obj;
...
class Category extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pDialog1 = new ProgressDialog(DermatologistActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                myorderAdapter = new MyOrderAdapter(DermatologistActivity.this, myorderArray);
                myorderListView.setAdapter(myorderAdapter);
