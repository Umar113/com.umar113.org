...
public class DentistActivity extends AppCompatActivity  {
    ...
    private static final String TAG_USERS = "dentist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/dentist.php";
    JSONObject json_obj;
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(DentistActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                if (status == 1) {
                    ...
                    myorderAdapter = new MyOrderAdapter(DentistActivity.this, myorderArray);
