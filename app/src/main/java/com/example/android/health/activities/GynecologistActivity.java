...
public class GynecologistActivity extends AppCompatActivity {
    ...
    private static final String TAG_USERS = "gynecologist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/gynecologist.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(GynecologistActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(GynecologistActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
