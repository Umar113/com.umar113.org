...
public class UrologyActivity extends AppCompatActivity {
    ...
    private static final String TAG_USERS = "urologist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/urologist.php";
    JSONObject json_obj;
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(UrologyActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(UrologyActivity.this, myorderArray);
