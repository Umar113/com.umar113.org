...
public class OrthopedistActivity extends AppCompatActivity{
    ...
    private static final String TAG_USERS = "orthopedist";
    JSONParser jParser = new JSONParser();
    String product_id, product_name, product_image, product_desc, product_actual_price, product_selling_price;
    int status = 0;
    JSONArray categories = null;
    public static final String LOGIN_URL = "http://ssinfotech.org/health/orthopedist.php";
    JSONObject json_obj;
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(OrthopedistActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                if (status == 1) {
                    myorderAdapter = new MyOrderAdapter(OrthopedistActivity.this, myorderArray);
