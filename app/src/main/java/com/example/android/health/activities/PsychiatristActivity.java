...
public class PsychiatristActivity extends AppCompatActivity {
    ...
    private static final String TAG_USERS = "psychiatrist";
    JSONParser jParser = new JSONParser();
    String product_id, product_name, product_image, product_desc, product_actual_price, product_selling_price;
    int status = 0;
    JSONArray categories = null;
    public static final String LOGIN_URL = "http://ssinfotech.org/health/psychiatrist.php";
    JSONObject json_obj;
    ...
    private class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(PsychiatristActivity.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                if (status == 1) {
                    myorderAdapter = new MyOrderAdapter(PsychiatristActivity.this, myorderArray);
