...
public class OphthalmologistActivity extends AppCompatActivity{
    ...
    private static final String TAG_USERS = "ophthalmologist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/ophthalmologist.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(OphthalmologistActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(OphthalmologistActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
