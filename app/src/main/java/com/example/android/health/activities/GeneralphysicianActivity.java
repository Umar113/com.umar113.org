 ...
 */
public class GeneralphysicianActivity extends AppCompatActivity  {
    private ProgressDialog pDialog1;
    private static final String TAG_SUCCESS = "status";
    private static final String TAG_USERS = "general_physician";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/general_physician.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(GeneralphysicianActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(GeneralphysicianActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
