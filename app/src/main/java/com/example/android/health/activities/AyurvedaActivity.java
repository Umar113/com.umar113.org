...
public class AyurvedaActivity extends AppCompatActivity{
    ...
    private static final String TAG_USERS = "ayurveda";
    JSONParser jParser = new JSONParser();
    int status = 0;
    JSONArray categories = null;
    public static final String LOGIN_URL = "http://ssinfotech.org/health/ayurveda.php";
    JSONObject json_obj;
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(AyurvedaActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (status == 1) {
                    ...
                    // looping through All Productsd.mn,
                ...
                //Toast.makeText(AyurvedaActivity.this,"Please Check your internet connection",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                if (status == 1) {
                    myorderAdapter = new MyOrderAdapter(AyurvedaActivity.this, myorderArray);
