...
public class NeurologistActivity extends AppCompatActivity{
    ...
    private static final String TAG_USERS = "neurologist";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/neurologist.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(NeurologistActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(NeurologistActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
