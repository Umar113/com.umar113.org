 ...
 */
public class HomeopathActivity extends AppCompatActivity{
    private ProgressDialog pDialog1;
    private static final String TAG_SUCCESS = "status";
    private static final String TAG_USERS = "homeopath";
    ...
    public static final String LOGIN_URL = "http://ssinfotech.org/health/homeopath.php";
    JSONObject json_obj;
...
//        myorderListView.setAdapter(myorderAdapter);
    ...
    class Category extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(HomeopathActivity.this);
...
//                    Toast.makeText(getApplicationContext(), "Successfully Taken", Toast.LENGTH_SHORT).show();
                    myorderAdapter = new MyOrderAdapter(HomeopathActivity.this, myorderArray);
                    myorderListView.setAdapter(myorderAdapter);
